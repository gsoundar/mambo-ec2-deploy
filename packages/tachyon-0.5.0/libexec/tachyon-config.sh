...
if [ -z "$TACHYON_SYSTEM_INSTALLATION" ]; then
  ...
  export TACHYON_JAR=$TACHYON_HOME/core/target/tachyon-0.5.0-jar-with-dependencies.jar:$TACHYON_HOME/lib/hadoop-nfs-2.4.1.jar:$TACHYON_HOME/lib/hadoop-connector-nfsv3-1.0.jar:$TACHYON_HOME/lib/netty-3.6.2.Final.jar
