...
public class TachyonFS {
   ...
   * @throws IOException
   */
  synchronized String createAndGetUserUnderfsTempFolder(Object ufsConf) throws IOException {
    connect();
    ...
    if (mUnderFileSystem == null) {
      mUnderFileSystem = UnderFileSystem.get(mUserUnderfsTempFolder, ufsConf);
    }
